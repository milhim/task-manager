...
import 'package:task_manager/src/features/auth/data/repositories/login_repository_impl.dart';
...
import 'package:task_manager/src/features/task_management/data/repositories/task_repository_impl.dart';
...
//repos
  ...
  serviceLocator.registerFactory<TaskRepository>(
    () => TaskRepositoryImpl(taskDataSource: serviceLocator()),
  );
